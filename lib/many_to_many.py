class Author:
    ...
    def books(self):
        """Returns a list of books written by this author using contracts."""
        return [contract.book for contract in self.contracts()]

    def sign_contract(self, book, date, royalties):
        """Creates and returns a new contract for the author."""
...
class Contract:
    ...
    def contracts_by_date(cls, date):
        """Returns all contracts with a matching date."""
